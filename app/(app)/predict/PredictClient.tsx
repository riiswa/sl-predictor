...
export default function PredictClient({ comp, categories, alreadySubmitted, existingPredictions, allComps }: Props) {
    ...
    return (
        <div className="flex flex-col gap-5">
            ...
            {/* Status bar — sticky */}
            <div className="sticky top-0 z-20 flex flex-col sm:flex-row sm:items-center justify-between gap-3 border-b border-blue/30 px-5 py-3 bg-dark shadow-md shadow-blue/10">
                {submitted && !editMode ? (
                    <div className="flex items-center gap-3">
                        <div className="w-2 h-2 rounded-full bg-green-400 flex-shrink-0" />
                        <div>
