...
export default function Button({
    ...
    const variants = {
        ...
        ghost:   'bg-transparent border border-blue/40 text-gray-muted hover:text-white hover:border-blue-light hover:shadow-sm hover:shadow-blue/20',
        danger:  'bg-transparent border border-accent/40 text-accent hover:bg-accent hover:text-white hover:shadow-lg hover:shadow-accent/20',
    }
